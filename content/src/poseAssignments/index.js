...
export const POSE_ASSIGNMENTS = { ...EXERCISE_POSES, ...TEAM_SPORT_POSES, ...INDIVIDUAL_SPORT_POSES, ...MISC_SPORT_POSES, ...COURT_SPORT_POSES, ...NET_SPORT_POSES, ...RACKET_SPORT_POSES, ...FIELD_SPORT_POSES, ...STICK_SPORT_POSES, ...RUNNING_POSES, ...ENDURANCE_POSES, ...BIKE_POSES, ...WATER_POSES, ...COMBAT_POSES };
