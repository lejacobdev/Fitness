...
const FIXTURES = new Set(['horse', 'climbwall', 'boat', 'surfboard', 'ramp', 'control', 'blocks', 'racingchair', 'bench', 'box', 'wall', 'bar', 'water', 'bike', 'rower', 'mat', 'hurdle', 'cone', 'ladder', 'net', 'wheelchair', 'sled', 'roller', 'ball', 'incline', 'kickball']);
const SAMPLES = 16;
