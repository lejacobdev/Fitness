...
const IMPLEMENTS = new Set(['bowlingballs', 'bow2', 'rifle2', 'flag', 'horn', 'towels', 'sword', 'map', 'lacrosse2', 'barbell', 'dumbbell', 'dumbbells', 'goblet', 'kettlebell', 'medball', 'plate', 'ball', 'football', 'puck',
...
const FIXTURES = new Set(['ramp', 'control', 'blocks', 'racingchair', 'bench', 'box', 'wall', 'bar', 'water', 'bike', 'rower', 'mat', 'hurdle', 'cone', 'ladder', 'net', 'wheelchair', 'sled', 'roller', 'ball', 'incline', 'kickball']);
const SAMPLES = 16;
